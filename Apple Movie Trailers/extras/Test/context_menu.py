...
class GUI( xbmcgui.WindowDialog ):
    ...
    def setButtonLabels( self ):
        ...
        if ( self.list_control == 'Trailer List' ):
            ...
            self.controls['Context Menu Button1']['special'][0] = self._( 510 )
            self.controls['Context Menu Button2']['control'].setLabel( self._( 502 + self.win.trailers.movies[self.list_item].favorite ) )
            self.controls['Context Menu Button2']['special'][0] = self._( 502 + self.win.trailers.movies[self.list_item].favorite )
            ...
            self.controls['Context Menu Button3']['special'][0] = '%s' % (self._( 504 + ( watched > 0 ) ) + watched_lbl, )
            self.controls['Context Menu Button4']['control'].setLabel( self._( 506 ) )
            self.controls['Context Menu Button4']['special'][0] = self._( 506 )
            self.controls['Context Menu Button5']['control'].setLabel( self._( 509 ) )
            self.controls['Context Menu Button5']['special'][0] = self._( 509 )
            if ( not self.win.trailers.complete ):
                self.controls['Context Menu Button%s' % ( self.saved + 5, ) ]['control'].setLabel( self._( 508 ) )
                self.controls['Context Menu Button%s' % ( self.saved + 5, ) ]['special'][0] = self._( 508 )
            ...
            if ( self.win.category_id == amt_util.GENRES ):
                ...
                self.controls['Context Menu Button1']['special'][0] = self._( 511 )
                self.controls['Context Menu Button2']['control'].setLabel( self._( 507 ) )
                self.controls['Context Menu Button2']['special'][0] = self._( 507 )
                if ( not self.win.trailers.complete ): 
                ...
                self.controls['Context Menu Button1']['special'][0] = self._( 512 )
                if ( not self.win.trailers.complete ): 
                    self.controls['Context Menu Button2']['control'].setLabel( self._( 508 ) )
                    self.controls['Context Menu Button2']['special'][0] = self._( 508 )
                    self.buttons = 2
            elif ( self.win.category_id ==  amt_util.ACTORS ):
                self.controls['Context Menu Button1']['control'].setLabel( self._( 513 ) )
                self.controls['Context Menu Button1']['special'][0] = self._( 513 )
                if ( not self.win.trailers.complete ): 
                    self.controls['Context Menu Button2']['control'].setLabel( self._( 508 ) )
                    self.controls['Context Menu Button2']['special'][0] = self._( 508 )
                    self.buttons = 2
    ...
    def setButtonFocused( self ):
        try:
            control = self.getFocus()
            for button in range( 6 ):
                if ( control == self.controls[ 'Context Menu Button%d' % ( button + 1, ) ]['control'] ):
                    textcolor = self.controls[ 'Context Menu Button%d' % ( button + 1, ) ]['special'][3]
                else:
                    textcolor = self.controls[ 'Context Menu Button%d' % ( button + 1, ) ]['special'][2]
                self.controls[ 'Context Menu Button%d' % ( button + 1, ) ]['control'].setLabel( self.controls[ 'Context Menu Button%d' % ( button + 1, ) ]['special'][0], self.controls[ 'Context Menu Button%d' % ( button + 1, ) ]['special'][1], textcolor )
        except: pass
