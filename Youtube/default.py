"""
    ...
    Changes Since 1.6
        ...
        - Fixed REGEXP Due to Site changes  (1.5)
        - Fixed Due to Site Changes (1.3)
        - Main Regexp string 'improved' (1.3)

    Incomplete: Used
        - i[3] == Thumbnail URL << might need to create a 'thread' for doing url stuff in background so not to slow down browsing

    Thumbnails i decided again as it will just slow things down.
...
#the_re_tempnew  =  re.compile("<title>([^<]*)</title>\n[^<]*<link>.'http://youtube.com/[?]v=([^']*)',.</link>")
...
class YouTube(xbmcgui.Window):
    def __init__(self):
        ...
        SetupButtons(self, 45,110, 155, 28, "Vert", button_hl,button_normal, 2,5)
        ...
        SetupButtons(self, 45,380, 155, 28, "Vert", button_hl,button_normal, 2,5)
        ...
        self.videoList = xbmcgui.ControlList(215,120, 450, 365,"font12",fc,yPath+"list-nofocus.png",yPath+"list-focus.png",itemTextXOffset=-10,)
...
class YouTubeProfile(xbmcgui.Window):
    def __init__(self):
        ...
        self.addControl(xbmcgui.ControlImage(0,0,720,576, yPath+"Background.png"))
        self.addControl(xbmcgui.ControlImage(50,45,200,60, yPathMain+"youtube.png"))
        self.lblCatergory = xbmcgui.ControlLabel(300,75,300,60,"",font=thefont14,textColor=fc)
        ...
        self.videoList = xbmcgui.ControlList(215,120, 450, 365,"font12",fc,yPath+"list-nofocus.png",yPath+"list-focus.png",itemTextXOffset=-10)
        self.addControl(self.videoList)
        self.friendList = xbmcgui.ControlList(215,120, 450, 365,"font12",fc,yPath+"list-nofocus.png",yPath+"list-focus.png",itemTextXOffset=-10)
        self.addControl(self.friendList)

        self.infoBox = xbmcgui.ControlTextBox(215,120, 450, 365,"font12",fc)
