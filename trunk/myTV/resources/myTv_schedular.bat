...
REM
FOR /F %%A IN ('DIR "G:\My Documents\My TV\myTV_rec_*.bat" /b /OD') DO ECHO %%A >> "G:\My Documents\My TV\Scheduled_log.txt"
FOR /F %%A IN ('DIR "G:\My Documents\My TV\myTV_rec_*.bat" /b /OD') DO CALL "G:\My Documents\My TV\%%A"
REM
REM Now delete the file
REM
FOR /F %%A IN ('DIR "G:\My Documents\My TV\myTV_rec_*.bat" /b /OD') DO DEL "G:\My Documents\My TV\%%A"
