...
xcopy elementtree "BUILD\%ScriptName%\elementtree" /E /Q /I /Y /EXCLUDE:BUILD\exclude.txt
xcopy xbmcutils "BUILD\%ScriptName%\xbmcutils" /E /Q /I /Y /EXCLUDE:BUILD\exclude.txt
