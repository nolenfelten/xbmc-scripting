...
class YouTube(xbmcgui.Window):
    def __init__(self):
        ...
        # MC360 NEW BLOCK
        #""" For When change this to a Window
        ...
        SetupButtons(self, int(90 * self.scaleX),int(95 * self.scaleY), int(180 * self.scaleX), int(28 * self.scaleY), "Vert", button_hl,button_normal, 2,5)
        ...
        SetupButtons(self, int(90 * self.scaleX),int(365 * self.scaleY), int(155 * self.scaleX), int(28 * self.scaleY), "Vert", button_hl,button_normal, 2,5)
        ...
        self.selT = 0
        self.mode = 0
        self.addControl(xbmcgui.ControlImage(int(60*self.scaleX),int(90*self.scaleY), int(210*self.scaleX),int(355*self.scaleY), "systemhomebutton-1-top.png"))
        self.contextUp = 0
        ct_x = 325
        if SD == "pdm":
            yPath = yPathMain+"gfx\\"           
        ...
        self.videoList = xbmcgui.ControlList(int(270 * self.scaleX),int(90 * self.scaleY), int(430 * self.scaleX), int(340 * self.scaleY),"font12",fc,yPath+"iconlist-nofocus.png",yPath+"iconlist-focus.png",itemTextXOffset=-10,)
