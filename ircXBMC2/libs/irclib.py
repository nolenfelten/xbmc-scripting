    ...
    def process_data(self):
        ...
        for line in lines:
            ...
            if command == "nick":
                ...
                self.real_nickname = arguments[0]
            if command == "namreply":
                #DONNO HACK: Auto handle this now coz can't get it working on main page
                pass
            if command == "nicknameinuse":
                #DONNO HACK: Auto handle this now coz it will slow stuff down if handels else wherer
